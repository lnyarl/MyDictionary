...
async function waitForServices(): Promise<void> {
  const { getTestDatabaseHelper } = await import("../src/common/database/test-database.helper");
  const { createTestRedisInstance } = await import("../src/common/cache/test-cache.module");
